...
class UsersTableSeeder extends Seeder
{
    ...
    {
        $users = [
            ['name' => 'Admin', 'email' => 'quockhanhnv0209@gmail.com', 'password' => Hash::make('admin123'), 'role'=> 100],
            ...
            ['name' => 'Le Trung Hieu', 'email' => 'hieult@gmail.com', 'password' => Hash::make('admin123'), 'role' => 5],
            ['name' => 'Doan Anh Hao', 'email' => 'haoda@gmail.com', 'password' => Hash::make('admin123'), 'role' => 5],
            ['name' => 'Le Xuan Duong', 'email' => 'duonglx@gmail.com', 'password' => Hash::make('admin123'), 'role' => 5],
            ['name' => 'Nguyen Huu Ba', 'email' => 'nvquockhanh0209@gmail.com', 'password' => Hash::make('admin123'), 'role' => 50],
            ['name' => 'Tran Van Quang', 'email' => 'nvqk0209@gmail.com', 'password' => Hash::make('admin123'), 'role' => 50],
